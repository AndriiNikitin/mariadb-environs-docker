...
[[ $ver1 =~ [1-9][0-9]?\.[0-9](\.[0-9][0-9]?)?(e)? ]] || { echo "Expected MariaDB version as first parameter, got ($ver1)" 1>&2; exit 1; }
...
mkdir m$mid2-system@$MATRIX_OSIMAGE
...
m${mid1}*/install.sh $ver1
m${mid2}*/install.sh $ver2
